...
class Categorie{
    ...
    public static function addCategorie($categorieName){
        ...
        try {
            ...
            header("Location: http://localhost/event_luxury/views/admin/admin_list_categorie.php");
    ...
    public static function updateCategorieById($id,$categorieName){
        ...
        try {
            ...
            header("Location: http://localhost/event/views/admin/admin_list_categorie.php");
