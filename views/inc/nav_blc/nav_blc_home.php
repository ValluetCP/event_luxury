...
<div id="modalInscription" class="modalContainer">
    <div class="modal_content">
        ...
        <a class="modal_close" href="#"><img class="img_croix_popup" src="http://localhost/event_luxury/views/asset/img/croix_close.svg" alt="fermer"></a>
                    ...
                    <div class="profil_nav">
                        ...
                        <div class="img_profil_nav" onclick="window.location.href='http://localhost/event_luxury/views/profil.php?id=<?= $_SESSION['id_user']; ?>'">
                            ...
                            <?php if (!empty($_SESSION) && $_SESSION['user_role'] == 'admin') { ?>
                                <a href="">
                                    <img class="img_profil" src="http://localhost/event_luxury/views/asset/img_event/calamar.JPG" alt="image profil">
                                </a>
                            <?php } elseif (!empty($_SESSION) && $_SESSION['user_role'] == 'client') { ?>
                                <a href="">
                                    <img class="img_profil" src="http://localhost/event_luxury/views/asset/img_event/coco2.JPG" alt="image profil">
                                </a>
                            <?php } else { ?>
                                <a href="">
                                    <img class="img_profil" src="http://localhost/event_luxury/views/asset/img_event/coco2.JPG" alt="image profil">
...
<?php
    ...
    <nav class="nav_home_page">
        ...
        <!-- BARRE DE NAVIGATION - début -->
        <div class="nav_logo">
            <a href="http://localhost/event_luxury/views/home_client.php"><img id="scrollLogoClair" class="logo logo_vert_clair" src="http://localhost/event_luxury/views/asset/img/img_logo/logo_vert_clair.svg" alt="logo"></a>
        </div>
        ...
        <div class="menu_nav grid_menu">
            <div class="menu_vert">
                <div class="nav2_container">
                    ...
                    <!-- LOGO - MENU DE NAVIGATION -->
                    <div class="logo_menu">
                        <a href="http://localhost/event_luxury/views/home_client.php"><img class="logo logo_vert_clair" src="http://localhost/event_luxury/views/asset/img/img_logo/logo_vert_clair.svg" alt="logo"></a>
                    </div>
                    <!-- PROFIL CONNEXION  - (prénom & image profil rond) -->
                    <div class="profil_nav">
        ...
        <div class="navigation hp_navigation">
            ...
            <div class="commande_navigation_header">
                ...
                <a href="http://localhost/event_luxury/views/inscription">
                    <p class="btnHome">Inscription</p>
                </a>

                <!-- Se connecter  -->
                <a href="http://localhost/event_luxury/views/connexion">
                    <p class="btnHome">Connexion</p>
                </a>
