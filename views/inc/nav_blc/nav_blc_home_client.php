...
<?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] == "admin") { ?>
    ...
    <nav class="navbar">
        ...
        <div class="nav_logo">
            ...
            <a href="http://localhost/event_luxury/views/home_client"><img id="scrollLogoFonce" class="logo logo_vert_fonce" src="http://localhost/event_luxury/views/asset/img/img_logo/logo_vert_fonce.svg" alt="logo"></a>
        </div>
