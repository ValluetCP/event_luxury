            ...
            <div class="nav2_container">
                ...
                <div class="profil_nav">
                    ...
                    <?php if(!empty($_SESSION) && $_SESSION['user_role'] == 'admin') { ?>                 
                        <a href="">
                            <img class="img_profil" src="http://localhost/event_luxury/views/asset/img_event/calamar.JPG" alt="">
                        </a>
                    <?php } elseif(!empty($_SESSION) && $_SESSION['user_role'] == 'client') { ?>
                        <a href="">
                            <img class="img_profil" src="http://localhost/event_luxury/views/asset/img_event/coco2.JPG" alt="">
                        </a>
                    <?php } else { ?>
                        <a href="">
                            <img class="img_profil" src="http://localhost/event_luxury/views/asset/img_event/coco2.JPG" alt="">
