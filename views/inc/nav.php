<nav>
  ...
  <?php } elseif (isset($_SESSION['user_role']) && $_SESSION['user_role'] == "client") { ?>
    ...
    <!-- <a href="http://localhost/event/views/panier_css.php">-P-</a> -->
    <a href="http://localhost/event/views/panier_css.php">Panier(<?= $_SESSION["nombre"] ?? ''; ?>)</a>
  ...
  <ul>
    <li class="nav-item active">
      <a class="nav-link" href="http://localhost/event/views/panier_css">
